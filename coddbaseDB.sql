-- --------------------------------------------------------
-- 호스트:                          ls-ee81ebabffa436fb8c00cd4c410d4466500c626b.cdy4okwq6zsy.ap-northeast-2.rds.amazonaws.com
...
-- 테이블 데이터 dbCodebase.comments:~41 rows (대략적) 내보내기
...
-- 테이블 데이터 dbCodebase.post:~36 rows (대략적) 내보내기
INSERT INTO `post` (`id`, `title`, `author`, `content`, `topic`, `createDate`, `likes`, `dislikes`, `views`) VALUES
	...
	(62, '화요일', '전현식구글', '20250121', '화요일', '2025-01-21 10:56:56', 0, 0, 6),
	(63, '250131', '전현식구글', '250131', '250131', '2025-01-31 13:02:06', 1, 0, 4);
...
INSERT INTO `project` (`id`, `title`, `content`, `price`, `hit`, `link`, `img`, `types`, `username`, `maker_id`, `isdelete`, `issoldout`) VALUES
	...
	(148, '교통 시뮬레이션 데이터셋 (대구)', '대구', 2000000, 8, '4d7609a2-691b-4c47-9951-12882d9c3ddc제목을-입력해주세요_-001 (1).png', '993ac7f3-adaf-4bed-9ea9-bd9f8021f562제목을-입력해주세요_-001 (1).png', NULL, 'user1', 3000, 'n', 'n'),
...
INSERT INTO `report_details` (`detail_id`, `report_id`, `member_id`, `content`, `report_date`) VALUES
	...
	(6, 44, 1056, '관련 없는 콘텐츠에요', '2025-01-13');
...
INSERT INTO `review` (`id`, `title`, `content`, `author`, `createdDate`, `views`, `likes`, `dislikes`, `pjtId`, `category`) VALUES
	...
	(53, '버튼테스트', '버튼테스트', 'g테스트', '2025-01-14 11:29:00', 15, 20, 10, 30, '팀원');
...
-- 테이블 데이터 dbCodebase.user_dislikes:~6 rows (대략적) 내보내기
...
-- 테이블 데이터 dbCodebase.visitor:~83 rows (대략적) 내보내기
